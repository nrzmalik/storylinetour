...
class TranslationManager {
  ...
  static translations = {
    intro: {
      ...
      ro: 'Bine ai venit la curs! Aceasta este zona de diapozitive unde va fi afișat conținutul cursului.',
    ...
    slide: {
      ...
      ro: 'Bine ai venit la curs! Aceasta este zona de diapozitive unde va fi afișat conținutul cursului. Folosește butoanele de navigare pentru a trece între diapozitive.',
    ...
    resources: {
      ...
      ro: 'Resurse ajutatoare: Aici poți găsi resurse utile legate de curs. Apasă pe linkuri pentru a accesa materiale sau referințe suplimentare.',
    ...
    menu: {
      ...
      ro: 'Meniu: Meniul cursului este localizat aici. Oferă o privire de ansamblu asupra structurii cursului și îți permite să sari la secțiuni sau module specifice.',
